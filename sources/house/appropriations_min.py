...
def fetch_appr_min_articles(start_date=None):
    results = []
    url = "https://democrats-appropriations.house.gov/news/press-releases"
    ...
    for article in articles:
        try:
            ...
            full_url = "https://democrats-appropriations.house.gov" + href
